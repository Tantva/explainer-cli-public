...
A real session, on a corpus outside the evaluation — a Mahabharata play.

The user states what they care about in plain words, and the pipeline starts from that:
